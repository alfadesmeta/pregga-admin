      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 12 }}>
        <button
          ...
          style={{
            ...
            padding: "8px 14px",
            borderRadius: 8,
            border: `1px solid ${filtersOpen ? PreggaColors.accent500 : PreggaColors.secondary300}`,
            background: filtersOpen ? PreggaColors.accent50 : PreggaColors.white,
            color: filtersOpen ? PreggaColors.accent700 : PreggaColors.neutral700,
            fontSize: 13,
            fontWeight: 500,
            cursor: "pointer",
            fontFamily: "inherit",
